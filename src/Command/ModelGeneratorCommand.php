...
class ModelGeneratorCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'dr360:gen:model';
    ...
    /**
     * ModelGeneratorCommand constructor.
    ...
    {
        return [
            ['table-name', 'tn', InputOption::VALUE_OPTIONAL, 'Name of database table', null],
            ['migration-path', 'mp', InputOption::VALUE_OPTIONAL, 'Source Directory of migrations', null],
            ['output-path', 'op', InputOption::VALUE_OPTIONAL, 'Target output Directory to store generated class', null],
