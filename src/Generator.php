...
/**
 * Class Generator
 * @package dr360\Generator
 */
class Generator
{
    /**
     * @var EloquentEngineering
     */
    protected $builder;
     ...
     * @param EloquentEngineering $builder
     * @param TypeRegistry $typeRegistry
     */
    public function __construct(EloquentEngineering $builder, TypeRegistry $typeRegistry)
    {
